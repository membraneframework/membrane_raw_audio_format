defmodule Membrane.Caps.Audio.Raw do
  ...
  def format_to_sample_size(:s8), do: 1
  def format_to_sample_size(:u8), do: 1
  def format_to_sample_size(:s16le), do: 2
  def format_to_sample_size(:s24le), do: 3
  def format_to_sample_size(:s32le), do: 4
  def format_to_sample_size(:u16le), do: 2
  def format_to_sample_size(:u24le), do: 3
  def format_to_sample_size(:u32le), do: 4
  def format_to_sample_size(:s16be), do: 2
  def format_to_sample_size(:s24be), do: 3
  def format_to_sample_size(:s32be), do: 4
  def format_to_sample_size(:u16be), do: 2
  def format_to_sample_size(:u24be), do: 3
  def format_to_sample_size(:u32be), do: 4
  def format_to_sample_size(:f32le), do: 4
  def format_to_sample_size(:f32be), do: 4
